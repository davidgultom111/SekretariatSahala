...
return [
    ...
    | testing domain as well as your production domain.
    |
    */
    ...
    */
    ...
    | purpose. For instance, you might prefix tokens issued to mobile apps
    | with "mobile" so you can easily identify the source of tokens.
    |
    */
